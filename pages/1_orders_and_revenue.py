...
with st.container():
    ...
    with row1_col1:
        ...
        fig = px.line(revenue_over_time, x='month', y='total_amount', title='Total Revenue Over Time')
    ...
    with row1_col2:
        ...
        fig = px.line(orders_over_time, x='month', y='header_id', title='Total Orders Over Time')
    ...
    with row2_col1:
        ...
        fig = px.line(percent_successful, x='month', y='payment_id', title='Percent of Successful Payments Over Time')
    ...
    with row2_col2:
        ...
        fig = px.line(new_customers_over_time, x='customer_created_month', y='customer_id', title='New Customers Over Time')
